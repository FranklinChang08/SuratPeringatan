  ...
  <div class="main-content">
    ...
    <section id="card-group" class="card-group">
      ...
      <div class="container">
        ...
        <div class="card" style="width: 15rem; height: 10rem">
          <div class="card-body">
            <h4 class="card-title">Surat Peringatan 2</h4>
            <div class="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-trash2-icon lucide-trash-2">
        ...
        <div class="card" style="width: 15rem; height: 10rem">
          <div class="card-body">
            <h4 class="card-title">Surat Peringatan 3</h4>
            <div class="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-trash2-icon lucide-trash-2">
            ...
            <div class="modal-body">
              <form action="" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="prodi" placeholder="Masukkan prodi mahasiswa...">
                </div>
                <div class="mb-3">
                  <label for="kelas" class="form-label">Kelas</label>
                  <input type="text" class="form-control" id="kelas" placeholder="Masukkan kelas mahasiswa...">
                </div>
                <div class="mb-3">
