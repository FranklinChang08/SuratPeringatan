            ...
            <div class="container">
                <div class="button d-flex justify-content-between flex-column flex-lg-row gap-2">
                    <div class="button-group">
                        <button type="button" class="btn btn-primary font-poppins" data-bs-toggle="modal" data-bs-target="#createPelanggaran">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                <button href="" class="btn btn-warning me-2 py-1 px-2" data-bs-toggle="modal" data-bs-target="#EditPelanggaran">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="EditPelanggaranLabel">Form Manejement Pelanggaran</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" class="needs-validation" novalidate id="formEditPelanggaran">
                                                    <div class="mb-3">
                                                        <label for="mahasiswaEdit" class="form-label">Mahasiswa</label>
                                                        <input type="text" class="form-control" id="mahasiswaEdit" required>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="jenis_suratEdit" class="form-label">Jenis Surat Peringatan</label>
                                                        <input type="text" class="form-control" id="jenis_suratEdit" required>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalEdit" class="form-label">Tanggal</label>
                                                        <input type="date" class="form-control" id="tanggalEdit" required>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="statusEdit" class="form-label">Status Pelanggaran</label>
                        ...
                        <div class="modal-body">
                            <form method="POST" class="needs-validation" novalidate id="formCreatePelanggaran">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="statusCreate" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
