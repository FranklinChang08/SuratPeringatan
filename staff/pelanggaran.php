                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="./backend/pelanggaran/create.php" class="needs-validation" novalidate autocomplete="off">
                                        <div class="mb-3">
                    ...
                    <div class="modal fade" id="editPelanggaran" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editPelanggaranLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="./backend/pelanggaran/update.php" class="needs-validation" novalidate autocomplete="off">
